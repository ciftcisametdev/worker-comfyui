...
* add missing libs needed for "opencv" to work ([33cd5d3](https://github.com/ciftcisametorg/worker-comfyui/commit/33cd5d349f76e4a393a3a4f3e99f954989b2c683))
* added missing start command ([9a7ffdb](https://github.com/ciftcisametorg/worker-comfyui/commit/9a7ffdb078d2f75194c86ed0b8c2d027592e52c3))
* check_server default values for delay and check-interval ([4945a9d](https://github.com/ciftcisametorg/worker-comfyui/commit/4945a9d65b55aae9117591c8d64f9882d200478e))
* convert environment variables to int ([#70](https://github.com/ciftcisametorg/worker-comfyui/issues/70)) ([7ab3d2a](https://github.com/ciftcisametorg/worker-comfyui/commit/7ab3d2a234325c2a502002ea7bdee7df3e0c8dfe))
* create directories which are required to run ComfyUI ([#58](https://github.com/ciftcisametorg/worker-comfyui/issues/58)) ([6edf62b](https://github.com/ciftcisametorg/worker-comfyui/commit/6edf62b0f4cd99dba5c22dd76f51c886f57a28ed))
* don’t persist credentials ([1546420](https://github.com/ciftcisametorg/worker-comfyui/commit/15464201b24de0746fe365e7635540330887a393))
* don't run ntpdate as this is not working in GitHub Actions ([2f7bd3f](https://github.com/ciftcisametorg/worker-comfyui/commit/2f7bd3f71f24dd3b6ecc56f3a4c27bbc2d140eca))
* got rid of syntax error ([c04de4d](https://github.com/ciftcisametorg/worker-comfyui/commit/c04de4dea93dbe586a9a887e04907b33597ff73e))
* images in subfolders are not working, fixes [#12](https://github.com/ciftcisametorg/worker-comfyui/issues/12) ([37480c2](https://github.com/ciftcisametorg/worker-comfyui/commit/37480c2d217698f799f6388ff311b9f8c6c38804))
* path should be "loras" and not "lora" ([8e579f6](https://github.com/ciftcisametorg/worker-comfyui/commit/8e579f63e18851b0be67bff7a42a8e8a46223f2b))
* removed xl_more_art-full_v1 because civitai requires login now ([2e8e638](https://github.com/ciftcisametorg/worker-comfyui/commit/2e8e63801a7672e4923eaad0c18a4b3e2c14d79c))
* return the output of "process_output_image" and access jobId correctly ([#11](https://github.com/ciftcisametorg/worker-comfyui/issues/11)) ([dc655ea](https://github.com/ciftcisametorg/worker-comfyui/commit/dc655ea0dd0b294703f52f6017ce095c3b411527))
* **semantic-release:** added .releaserc ([#21](https://github.com/ciftcisametorg/worker-comfyui/issues/21)) ([12b763d](https://github.com/ciftcisametorg/worker-comfyui/commit/12b763d8703ce07331a16d4013975f9edc4be3ff))
* start the container in all cases ([413707b](https://github.com/ciftcisametorg/worker-comfyui/commit/413707bf130eb736afd682adac8b37fa64a5c9a4))
* update runpod to 1.7.12 ([#144](https://github.com/ciftcisametorg/worker-comfyui/issues/144)) ([c689eda](https://github.com/ciftcisametorg/worker-comfyui/commit/c689eda26b8d9505a0a63d6d4af6f8cab997e24f))
* update the version inside of semanticrelease ([d93e991](https://github.com/ciftcisametorg/worker-comfyui/commit/d93e991b82251d62500e20c367a087d22d58b20a))
* updated path to "comfyui" ([37f66d0](https://github.com/ciftcisametorg/worker-comfyui/commit/37f66d04b8c98810714ffbc761412f3fcdb1d861))
* use custom GITHUB_TOKEN to bypass branch protection ([9b6468a](https://github.com/ciftcisametorg/worker-comfyui/commit/9b6468a40b8a476d7812423ff6fe7b73f5f91f1d))
* use proper example that actually can be copied & pasted ([506fac1](https://github.com/ciftcisametorg/worker-comfyui/commit/506fac10480ec238110ae0dcb59b0b6865879471))


### Features

* add COMFY_ORG_API_KEY; updated logo in hub ([#176](https://github.com/ciftcisametorg/worker-comfyui/issues/176)) ([e7c259e](https://github.com/ciftcisametorg/worker-comfyui/commit/e7c259e92939e517222133ed7bce04de90e37d36))
* add support for 5090/B200 ([#150](https://github.com/ciftcisametorg/worker-comfyui/issues/150)) ([7492513](https://github.com/ciftcisametorg/worker-comfyui/commit/7492513490bc1723503dded682ee2c313a1c8ea6))
* added COMFY_LOG_LEVEL to control the logs from ComfyUI ([183de1c](https://github.com/ciftcisametorg/worker-comfyui/commit/183de1cdececa217abcbec30545e24c5820eba97))
* added default ComfyUI workflow ([fa6c385](https://github.com/ciftcisametorg/worker-comfyui/commit/fa6c385e0dc9487655b42772bb6f3a5f5218864e))
* added FLUX.1 schnell & dev ([9170191](https://github.com/ciftcisametorg/worker-comfyui/commit/9170191eccb65de2f17009f68952a18fc008fa6a))
* added runpod as local dependency ([9deae9f](https://github.com/ciftcisametorg/worker-comfyui/commit/9deae9f5ec723b93540e6e2deac04b8650cf872a))
* added script "comfy-manager-set-mode" to set the "network mode" ([4d5425f](https://github.com/ciftcisametorg/worker-comfyui/commit/4d5425f211b85b95e4953f6c0ddf27ed92e3cfa1))
* added script "comfy-node-install" as a wrapper to "comfy-cli" to proivde a proper exit code when something is not corret ([6605506](https://github.com/ciftcisametorg/worker-comfyui/commit/660550637bceb72052ef7c1dec9d6f36035a2fd2))
* added sensible defaults and default platform ([3f5162a](https://github.com/ciftcisametorg/worker-comfyui/commit/3f5162af85ee7d0002ad65a7e324c3850e00a229))
* added support for hub ([c8dd49c](https://github.com/ciftcisametorg/worker-comfyui/commit/c8dd49cc2d8c23d58b48b1823bdecc3267f9accd))
* added unit tests for everthing, refactored the code to make it better testable, added test images ([a7492ec](https://github.com/ciftcisametorg/worker-comfyui/commit/a7492ec8f289fc64b8e54c319f47804c0a15ae54))
* added xl_more_art-full_v1, improved comments ([9aea8ab](https://github.com/ciftcisametorg/worker-comfyui/commit/9aea8abe1375f3d48aa9742c444b5242111e3121))
* automatically update latest version ([7d846e8](https://github.com/ciftcisametorg/worker-comfyui/commit/7d846e8ca3edcea869db3e680f0b423b8a98cc4c))
* base64 image output ([#8](https://github.com/ciftcisametorg/worker-comfyui/issues/8)) ([76bf0b1](https://github.com/ciftcisametorg/worker-comfyui/commit/76bf0b166b992a208c53f5cb98bd20a7e3c7f933))
* cleanup comfyui to move from blibla to runpod ([#115](https://github.com/ciftcisametorg/worker-comfyui/issues/115)) ([b424b22](https://github.com/ciftcisametorg/worker-comfyui/commit/b424b22a415c1f4c966289619b4d019c245c33f1))
* debug "network volume model paths" issues ([#185](https://github.com/ciftcisametorg/worker-comfyui/issues/185)) ([d0f6992](https://github.com/ciftcisametorg/worker-comfyui/commit/d0f699290a06056c8d0e131abbf2d753ea7f4f02))
* default version is "latest" to have something even on the hub ([160906f](https://github.com/ciftcisametorg/worker-comfyui/commit/160906f35b8f5949c2073a8443c0fb04a45c3c56))
* **docker:** add z-image-turbo image with alibaba tongyi models ([#189](https://github.com/ciftcisametorg/worker-comfyui/issues/189)) ([0e2bf22](https://github.com/ciftcisametorg/worker-comfyui/commit/0e2bf226f9ee3d7b6725f61ffbee652b67b6d172))
* example on how to configure the .env ([4ed5296](https://github.com/ciftcisametorg/worker-comfyui/commit/4ed529601394e8a105d171ab1274737392da7df5))
* image-input, renamed "prompt" to "workflow", added "REFRESH_WORKER" ([#14](https://github.com/ciftcisametorg/worker-comfyui/issues/14)) ([5f5e390](https://github.com/ciftcisametorg/worker-comfyui/commit/5f5e390dfda9d3ef8ce9b5578aade1bee600bf5c))
* improved logging & provide actual reason why the workflow validation might fail ([7582999](https://github.com/ciftcisametorg/worker-comfyui/commit/7582999209d9683c198aa1c6d3793a16fe059416))
* logs should be written to stdout so that we can see them inside the worker ([fc731ff](https://github.com/ciftcisametorg/worker-comfyui/commit/fc731fffcd79af67cf6fcdf6a6d3df6b8e30c7b5))
* multiple output images; replace http polling with websocket to check when a workflow is done ([#118](https://github.com/ciftcisametorg/worker-comfyui/issues/118)) ([b14068f](https://github.com/ciftcisametorg/worker-comfyui/commit/b14068f8e7da4790d2de5d4b710a08d26d0c131f))
* network-volume; execution time config; skip default images; access ComfyUI via web ([#35](https://github.com/ciftcisametorg/worker-comfyui/issues/35)) ([070cde5](https://github.com/ciftcisametorg/worker-comfyui/commit/070cde5460203e24e3fbf68c4ff6c9a9b7910f3f)), closes [#16](https://github.com/ciftcisametorg/worker-comfyui/issues/16)
* prepare the worker for the hub ([0989151](https://github.com/ciftcisametorg/worker-comfyui/commit/098915171cec83b91338ae8dfd82a4c2b82ccdee))
* run the worker locally ([#19](https://github.com/ciftcisametorg/worker-comfyui/issues/19)) ([34eb32b](https://github.com/ciftcisametorg/worker-comfyui/commit/34eb32b72455e6e628849e50405ed172d846d2d9))
* simplified and added compatibility with Windows ([9f41231](https://github.com/ciftcisametorg/worker-comfyui/commit/9f412316a743f0539981b408c1ccd0692cff5c82))
* simplified input ([35c2341](https://github.com/ciftcisametorg/worker-comfyui/commit/35c2341deca346d4e6df82c36e101b7495f3fc03))
* simplified input to just have "prompt", removed unused code ([0c3ccda](https://github.com/ciftcisametorg/worker-comfyui/commit/0c3ccda9c5c8cdc56eae829bb358ceb532b36371))
* support sd3 ([#46](https://github.com/ciftcisametorg/worker-comfyui/issues/46)) ([dde69d6](https://github.com/ciftcisametorg/worker-comfyui/commit/dde69d6ca75eb7e4c5f01fd17e6da5b62f8a401f))
* update comfyui to 0.3.26 ([ac0269e](https://github.com/ciftcisametorg/worker-comfyui/commit/ac0269e683a0bcba43fafad40d4b56f51cad2588))
* update comfyui to 0.3.43 ([#145](https://github.com/ciftcisametorg/worker-comfyui/issues/145)) ([32c2395](https://github.com/ciftcisametorg/worker-comfyui/commit/32c23956a44dae4cd3800d6de9491539065a200a))
* updated path to "comfyui", added "ntpdate" to have the time of the container in sync with AWS ([2fda578](https://github.com/ciftcisametorg/worker-comfyui/commit/2fda578d62460275abec11d6b2fbe5123d621d5f))
* updated to ubuntu 24.04 & python 3.12 to support ffmpeg 6 ([eb8dd26](https://github.com/ciftcisametorg/worker-comfyui/commit/eb8dd265e0823b39974dc91bbb489b54ac92c8d3))
* use local ".env" to load env variables, mount "comfyui/output" to localhost so that people can see the generated images ([aa645a2](https://github.com/ciftcisametorg/worker-comfyui/commit/aa645a233cd6951d296d68f7ddcf41b14b3f4cf9))
* use models from huggingface, not from local folder ([b1af369](https://github.com/ciftcisametorg/worker-comfyui/commit/b1af369bb577c0aaba8875d8b2076e1888356929))
* wait until server is ready, wait until image generation is done, upload to s3 ([ecfec13](https://github.com/ciftcisametorg/worker-comfyui/commit/ecfec1349da0d04ea5f21c82d8903e1a5bd3c923))
